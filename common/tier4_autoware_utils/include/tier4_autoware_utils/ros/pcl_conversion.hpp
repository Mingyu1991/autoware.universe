...
{
/**
 * @brief a faster implementation of converting sensor_msgs::msg::PointCloud2 to pcl::PointCloud<pcl::PointXYZ> and transform the cloud
 * 
 * @tparam Scalar 
...
void transformPointCloudFromROSMsg(
  const sensor_msgs::msg::PointCloud2 &cloud, pcl::PointCloud<pcl::PointXYZ> &pcl_cloud, const Eigen::Matrix<Scalar, 4, 4> &transform)
{  
  // Copy info fields
