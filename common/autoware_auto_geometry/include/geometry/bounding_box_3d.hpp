...
public:
  BoundingBox3D(
    ...
    const tf2::Quaternion & orientation = tf2::Quaternion(0.0, 0.0, 0.0, 1.0), double length = 0.0,
    double width = 0.0, double height = 0.0);
  explicit BoundingBox3D(const autoware_auto_perception_msgs::msg::PredictedObject & object);
  /**
   ...
   */
  inline void setPosition(const tf2::Vector3 & position) { this->position_ = position; }
  /**
