...
int compareRecord(const traffic_light::FusionRecord & r1, const traffic_light::FusionRecord & r2)
{
  ...
  */
  ...
  bool r1_is_unknown = isUnknown(r1.light);
  bool r2_is_unknown = isUnknown(r2.light);
  /*
    ...
    if (
      ...
      */
      ...
      for (size_t i = 0; i < record_arr.rois.rois.size(); i++) {
        ...
        */
        if (light_it == record_arr.lights.lights.end()) {
          continue;
        }
        FusionRecord record{record_arr.header, record_arr.cam_info, roi, *light_it};
        /*
